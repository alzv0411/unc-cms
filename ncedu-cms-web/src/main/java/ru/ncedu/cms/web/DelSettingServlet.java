 ...
 * @author dmitry
 */
@WebServlet(name = "DelSettingServlet", urlPatterns = {"/delsetting"})
public class DelSettingServlet extends HttpServlet {        
    @EJB
    HelloBean helloBean;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException {
            ...
            if (StringUtils.isNotEmpty(name)) {
                ...
                if (setting == null) {
                    request.setAttribute("message", "setting = " + name + " doesn't exist");
