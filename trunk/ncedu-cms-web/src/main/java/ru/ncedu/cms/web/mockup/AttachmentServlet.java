 ...
 */
@WebServlet(name = "AttachmentServlet", urlPatterns = {"/mockup/attachment"})
public class AttachmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (StringUtils.isNotEmpty(attachId)) {
            ...
            request.getRequestDispatcher("/views/mockup/attachment.jsp").forward(request, response);
        }

        List<Attachment> attachments = attachDAO.findAll();
        request.setAttribute("attachments", attachments);
        request.getRequestDispatcher("/views/mockup/attachments.jsp").forward(request, response);
    }
